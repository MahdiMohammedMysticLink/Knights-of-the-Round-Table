...
public class RankDeck
{
    ...
    public bool remove(rankCard c)
    {
        ...
        if (c.getRankType() == "SQUIRE")
        {
            return squires.remove(c.getName());
        ...
        if (c.getRankType() == "KNIGHT")
        {
            return knights.remove(c.getName());
        ...
        if (c.getRankType() == "CHAMPIONKNIGHT")
        {
            ...
            return championKnights.remove(c.getName());
